  ...
  return (
    <div style={{ width: "100%", height: "100%" }}>
      <div style={{ width: "1270px", height: "100%", margin: "0 auto" }}>
        ...
        <h1 style={{ color: "#fff", fontSize: "300%", padding: "0 20px" }}>
          Configuration
        </h1>
        <table
          style={{ color: "white", fontSize: "20px", paddingBottom: "70px" }}
        >
          <thead>
            <tr>
        ...
        >
          <div>
            ...
            <h4>What is LOL?</h4>
            <p>
              League of Legends (LoL) is a popular multiplayer online game
              developed by Riot Games.
            </p>
            <p>
              It was released in 2009 and has since become one of the most
              played PC games worldwide, with millions{" "}
            </p>
            <p>
              It features a diverse range of champions, each with unique
              abilities.
            </p>
            <p>
              The game is known for its strategic gameplay and vibrant esports
              scene.
            </p>
          </div>
          <div>
            ...
            <ul>
              <li style={{ paddingBottom: "20px" }}>
                <u style={{ color: "#9932CC" }}>Genres:</u> Action, Adventure,
                Indie
              </li>
              <li style={{ paddingBottom: "20px" }}>
                <u style={{ color: "#9932CC" }}>Platforms:</u> Windows, macOS,
                Linux
              </li>
              <li style={{ paddingBottom: "20px" }}>
                <u style={{ color: "#9932CC" }}>Languages:</u> English, French,
                Vietnamese...
              </li>
              <li style={{ paddingBottom: "20px" }}>
              ...
              <li style={{ paddingBottom: "20px" }}>
                <u style={{ color: "#9932CC" }}> ESRB Ratings:</u> Teen
              </li>
            </ul>
          </div>
        </div>
